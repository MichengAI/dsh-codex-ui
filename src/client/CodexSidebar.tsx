...
const stylesheet = `
.dcu-root{--dcu-font:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI","Microsoft YaHei UI",sans-serif;height:100%;min-width:0;box-sizing:border-box;display:flex;flex-direction:column;background:#eef7f5;color:var(--dsw-alias-label-primary);font:14px/20px var(--dcu-font)}body[data-ds-dark-theme] .dcu-root{background:#1c1f1e}
...
.dcu-icon,.dcu-menu button,.dcu-footer-link{appearance:none;border:0;background:transparent;color:inherit;font:inherit;cursor:pointer}.dcu-icon{display:grid;place-items:center;width:36px;height:36px;border-radius:8px;color:var(--dsw-alias-label-primary)}
...
.dcu-extension-items{display:grid;gap:1px;margin:1px 0 4px 22px;padding-left:6px;border-left:1px solid var(--dsw-alias-border-l2)}.dcu-extension-items button{color:var(--dsw-alias-label-secondary);font-size:14px;font-weight:400}
.dcu-workspaces{display:flex;min-height:0;flex:1;flex-direction:column;margin-top:2px;padding-top:8px;border-top:1px solid var(--dsw-alias-border-l1)}.dcu-native-workspaces{display:flex;min-height:0;flex:1}.dcu-native-workspaces>*{min-width:0;flex:1}.dcu-foot{display:grid;gap:4px;padding:8px 10px 12px;border-top:1px solid var(--dsw-alias-border-l1)}.dcu-footer-actions:empty,.dcu-settings-seat:empty{display:none}.dcu-settings-seat>button{width:100%;min-height:36px;padding-left:4px!important;color:var(--dsw-alias-label-primary);font:14px/20px var(--dcu-font);font-weight:500}.dcu-compact{align-items:center;padding:12px 0}.dcu-compact .dcu-icon{width:40px;height:40px}.dcu-compact .dcu-workspaces{width:100%;flex:1}.dcu-compact .dcu-foot{margin-top:auto;padding:8px 0;border-top:0}.dcu-compact .dcu-footer-link{display:flex;justify-content:center;width:40px;padding:0;font-size:0}.dcu-compact .dcu-footer-link svg{width:18px;height:18px}
.dcu-dependency-notice{margin:0 10px 8px;border:1px solid var(--dsw-alias-border-l2);border-radius:8px;padding:8px;color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}
[role="dialog"][aria-labelledby]{width:min(1200px,calc(100vw - 48px));max-width:calc(100vw - 48px);height:min(1200px,calc(100vh - 48px))}
.dcu-search-scrim{position:fixed;z-index:10020;inset:0;display:flex;justify-content:center;align-items:flex-start;padding:72px 20px;background:color-mix(in srgb,#000 48%,transparent)}.dcu-search-dialog{width:min(560px,100%);max-height:min(640px,calc(100vh - 120px));overflow:auto;border:1px solid var(--dsw-alias-border-l2);border-radius:16px;padding:10px;background:var(--dsw-specific-menu);box-shadow:var(--dsw-shadow-lv4)}.dcu-search-input{margin-bottom:8px}.dcu-search-section{padding:6px 0}.dcu-search-title{padding:0 8px 4px;color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:600}.dcu-search-row{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:12px;width:100%;min-height:34px;border:0;border-radius:8px;padding:6px 8px;background:transparent;color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer}.dcu-search-row:hover,.dcu-search-row[data-active=true]{background:var(--dsw-alias-interactive-bg-hover)}.dcu-search-main{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.dcu-search-detail{max-width:160px;overflow:hidden;color:var(--dsw-alias-label-tertiary);font-size:12px;text-overflow:ellipsis;white-space:nowrap}.dcu-search-empty{padding:18px 8px;color:var(--dsw-alias-label-tertiary);font-size:13px}
