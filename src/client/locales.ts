...
export const zh = {
  ...
  'about.feature.workspace': '项目与会话分组、置顶、归档、重命名与删除操作',
  'about.feature.conversation': '保留原生消息、工具调用、输入、权限和模型选择，仅调整容器视觉',
  'about.dependencies': '配套管理插件',
  'about.dependenciesDescription': '安装以下插件可获得专家、技能和已归档会话的完整管理体验。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'about.feature.workspace': 'Workspace and conversation grouping, pinning, archiving, renaming, and deletion',
  ...
  'about.dependenciesDescription': 'Install these plugins for the full experts, skills, and archived-conversation management experience.',
