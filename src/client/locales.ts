...
export const zh = {
  ...
  'sessions.waitingApproval': '等待批准',
  'sessions.planReview': '计划审核',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'sessions.waitingAnswer': 'Waiting answer',
  'sessions.waitingApproval': 'Waiting approval',
  'sessions.planReview': 'Plan review',
