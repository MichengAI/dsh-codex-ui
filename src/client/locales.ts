...
export const zh = {
  ...
  'about.dependenciesDescription': '每个配套插件都可单独安装和更新，也可一键安装缺失项并更新旧版本。可分别检查 Codex UI、专家、技能、归档、IM、定时任务、宠物、BTW、Simplify 和第三方插件市场。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'about.dependenciesDescription': 'Install or update each companion separately, or install missing plugins and update old versions in one action. Check Codex UI, expert, skill, archive, IM, scheduled-task, pet, BTW, Simplify, and marketplace plugins on their own.',
