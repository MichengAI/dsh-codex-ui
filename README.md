...
Project and conversation menus use only public DSH services. The workspace tree lists ordinary, active conversations and supports opening, local pin/unpin and unread markers, renaming, deleting a project registration, archiving, forking, ZIP export, opening the workspace folder, and copying the path/title/ID/deep link. Deleting a project registration leaves its folder and conversation records intact.
