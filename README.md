...
- The workspace tree is a plugin implementation rendered through the public `sidebar.workspaces` slot. It keeps the native hierarchy, collapse, search, hover, and drag-ordering interaction model while adding project pinning and richer conversation actions.
