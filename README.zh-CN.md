...
当前工作区已声明支持 DSH `0.1.5-rc.1`、`0.1.5-rc.2` 与 `0.1.7-rc.1`。开发依赖钉在 `0.1.7-rc.1`。`@deepseek-ai/dsh-client-runtime` 没有 0.1.7 包，继续使用已发布最高版 `0.1.1-rc.2`。隔离宿主检查覆盖 `0.1.5-rc.1`、`0.1.5-rc.2` 与 `0.1.7-rc.1`。
