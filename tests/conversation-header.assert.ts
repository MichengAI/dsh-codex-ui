...
assert.doesNotMatch(header, /\[class\*="headerUtilities"\]\{[^}]*margin-left:auto/, '靠右的是页签，不是扩展区')
...
assert.match(header, /translate\(1.5 2.429\)/, '顶栏文件夹必须使用官方 IconFolderCloseMedium 路径')
