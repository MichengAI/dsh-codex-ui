...
assert.match(workspace, /<SessionTime time=\{formatHoverTime\(session\.updatedAt, t\)\}/, '项目内会话必须在行右侧显示相对时间')
assert.match(workspace, /time=\{formatHoverTime\(session\.updatedAt, t\)\}/, '最近会话必须在行右侧显示相对时间')
assert.match(channel, /time=\{updatedAt === undefined \? undefined : formatHoverTime\(updatedAt, t\)\}/, '频道会话必须在行右侧显示相对时间')
assert.match(schedule, /time=\{session\.updatedAt === undefined \? undefined : formatHoverTime\(session\.updatedAt, t\)\}/, '定时会话必须在行右侧显示相对时间')
