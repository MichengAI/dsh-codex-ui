...
assert.match(sidebar, /className=\{`dcu-root\$\{compact \? ' dcu-compact' : ''\}`\}/, '收缩后必须立刻切到窄轨样式')
...
assert.match(sidebar, /\[data-dcu-sidebar-frame\]\{transition:none!important\}/, '侧栏列宽不得逐帧触发布局动画')
