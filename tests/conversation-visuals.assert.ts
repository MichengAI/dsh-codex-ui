...
assert.match(sidebar, /html:has\(\[data-dcu-official-turn-navigator\]\) \.dcu-turn-navigator\{display:none\}/, '检测到实际官方导航后必须隐藏旧版自定义刻度')
...
assert.match(sidebar, /\[data-dcu-official-turn-navigator\]>\[role="tooltip"\]\{right:auto!important;left:calc\(100% \+ 10px\)!important/, '左侧官方导航的预览气泡必须向右展开')
