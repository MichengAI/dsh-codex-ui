...
assert.match(sidebar, /--dcu-sidebar-primary:#393d3e;--dcu-sidebar-secondary:#676b6c;--dcu-sidebar-tertiary:#9a9f9f;--dcu-sidebar-icon:#4e5253/, '浅色侧栏必须使用 Codex 风格的中性灰文字层级，不能接近纯黑')
assert.match(sidebar, /--dcu-sidebar-primary:#b9bab9;--dcu-sidebar-secondary:#909191;--dcu-sidebar-tertiary:#666867;--dcu-sidebar-icon:#afafaf/, '暗色侧栏必须使用 Codex 风格的中性灰文字层级，不能接近纯白')
