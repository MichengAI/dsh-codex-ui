...
assert.match(manager, /\['add', `\$\{dependency\.packageName\}@latest`\]/, '未安装依赖必须通过 dsh plugin add 从 npm 获取 latest')
assert.match(manager, /\['update', '--latest', dependency\.packageName\]/, '已安装依赖必须通过 pnpm update --latest 强制刷新 lockfile')
