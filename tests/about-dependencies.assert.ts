...
assert.deepEqual(MANAGED_DEPENDENCIES.slice(btwIndex - 2, btwIndex + 3).map(dependency => dependency.id), ['schedule', 'pet', 'btw', 'simplify', 'market'], '宠物必须紧随定时任务，Simplify 必须紧随 BTW，并位于第三方市场之前')
